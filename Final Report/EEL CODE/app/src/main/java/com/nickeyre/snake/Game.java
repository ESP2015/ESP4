...
public class Game extends View {
  ...
  public class Block {
    ...
    public void setType(int type){
      switch(type){
        case 0:
          if(darkTheme) shape.getPaint().setColor(Color.parseColor("#ff1e90ff"));
          else shape.getPaint().setColor(Color.parseColor("#ff1e90ff"));
          break;
        case 1:
          shape.getPaint().setColor(Color.parseColor("#ff006400"));
          break;
        case 2:
